...
echo [INFO] Chua tim thay source AutoResearchClaw. Dang tai tu GitHub...
where git >nul 2>&1
...
echo [WARN] Clone that bai. Repo co the yeu cau dang nhap GitHub.
...
if errorlevel 1 (
    echo [ERROR] Giai nen source that bai.
    pause
    exit /b 1
)
